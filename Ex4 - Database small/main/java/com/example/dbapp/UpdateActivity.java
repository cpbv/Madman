        ...
        insert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!id.getText().toString().matches("[A-Za-z0-9]+") || !c.moveToNext()) {
                    ...
                    msg = "Updated!";
                    db.execSQL("UPDATE EMPLOYEES SET NAME = ?, GENDER = ?, SALARY = ? WHERE ID = ?;", new String[]{name.getText().toString(), sel.getText().toString(), salary.getText().toString(), id.getText().toString()});
                }
